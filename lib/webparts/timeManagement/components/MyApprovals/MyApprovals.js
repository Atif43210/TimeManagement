...
var MyApprovals = /** @class */ (function (_super) {
    __extends(MyApprovals, _super);
    ...
    MyApprovals.prototype.componentDidMount = function () {
        this.props.getRequestDetails();
    };
    MyApprovals.prototype.render = function () {
        var selectionDetails = this.state.selectionDetails;
        return (React.createElement(Fabric, { className: styles.myApprovals },
            React.createElement(Label, { className: styles.heading }, "My Approvals"),
            ...
            React.createElement(MarqueeSelection, { selection: this._selection },
                React.createElement(DetailsList, { items: this.props.approvals, columns: this._columns, setKey: "set", layoutMode: DetailsListLayoutMode.justified, selection: this._selection, selectionPreservedOnEmptyClick: true, ariaLabelForSelectionColumn: "Toggle selection", ariaLabelForSelectAllCheckbox: "Toggle selection for all items", checkButtonAriaLabel: "Row checkbox", onItemInvoked: this._onItemInvoked }))));
    };
    MyApprovals.prototype._getSelectionDetails = function () {
